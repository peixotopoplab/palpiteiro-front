...
function ConteudoTermos() {
  return (
    <div className="space-y-5 text-body-md text-text-muted leading-relaxed">
      ...
      {[
        ["1. Natureza do Serviço", "O Palpiteiro é um serviço de publicação editorial digital de conteúdo informativo e estatístico voltado ao futebol e aos concursos oficiais da Loteca da Caixa Econômica Federal. O serviço compreende a edição e publicação de listas de análises estatísticas esportivas, boletins periódicos de dados e probabilidades, e acesso a conteúdo editorial digital informativo. Não é uma casa de apostas, não recebe apostas e não intermedia pagamentos lotéricos. As análises têm caráter exclusivamente educativo e informativo — não constituem aconselhamento financeiro nem garantia de premiação."],
        ...
        ["5. Planos e Assinatura", "O plano gratuito (Free) é permanente e não exige pagamento. O plano VIP é uma assinatura recorrente de acesso a publicações e listas de análises estatísticas esportivas, processada pelo Mercado Pago. Os preços e condições são gerenciados pelo Palpiteiro e podem ser alterados com aviso prévio de 30 dias. O cancelamento pode ser feito a qualquer momento em Minha Conta."],
